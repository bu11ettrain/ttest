...
# 		screen -dmS gram_$i bash -c "while true; do node ~/JettonGramGpuMiner/send_universal.js --api tonhub --givers 100 --timeout 5 --bin ~/JettonGramGpuMiner/pow-miner-cuda --gpu $i; sleep 1; done"
# 	done
#  screen -ls
